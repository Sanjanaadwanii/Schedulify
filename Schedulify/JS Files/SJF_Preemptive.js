...
function resetAll() {
  ...
  <div id="gantt-placeholder">⏳ Gantt chart will appear here after simulation</div>
`;
...
async function runSJFPreemptive() {
  ...
  while (completed < processes.length) {
    ...
    if (lastPid !== current.pid) {
      ...
      block.setAttribute("data-time", `t = ${time}`);
